...
import * as queries from '@services/bookings/queries';
import * as atomic from '@services/bookings/atomic';
import { coerceDate, uuidString } from '@utils/valibot';
...
const updateInputSchema = v.partial(v.omit(createInputSchema, ['offeringId', 'customerId']));
